...
drop materialized view if exists erc20_transfer;

create materialized view erc20_transfer auto refresh yes as
...
-- test
select value_uint64_array, value_uint128_array from erc20_transfer where date > '2020-01-01' limit 100;
...
select count(1) from erc20_transfer where value_uint128_array is null; -- 88515

select sum(value_uint128_array[1]), "to" from erc20_transfer where address = '0xdac17f958d2ee523a2206206994597c13d831ec7' group by 2 order by 1 desc limit 100; -- execution: 35 s 422 ms

select data::text from erc20_transfer where address = '0xdac17f958d2ee523a2206206994597c13d831ec7' and value_uint128_array is null; -- no overflow for USDT

select count(1), address from erc20_transfer where value_uint128_array is null group by address; -- overflow offenders

select date, sum(value_uint128_array[1]) from erc20_transfer where address = '0xdac17f958d2ee523a2206206994597c13d831ec7' group by 1 order by 1 desc; -- execution: 15 s 532 ms; entire history USDT from 2017

select date, count(1) from erc20_transfer where address = '0xdac17f958d2ee523a2206206994597c13d831ec7' group by 1 order by 1 desc; -- execution: 13 s 706 ms

select count(1) from erc20_transfer where address = '0xdac17f958d2ee523a2206206994597c13d831ec7'; -- 166 613 312 usdt

select count(1), address from erc20_transfer group by 2 order by 1 desc limit 100; -- top tokens
...
-- test usdt_transfer vs erc20_transfer
select sum(value_uint128_array[1]), "to" from usdt_transfer group by 2 order by 1 desc limit 10000; -- execution: 8 s 262 ms
select sum(value_uint128_array[1]), "to" from erc20_transfer where address = '0xdac17f958d2ee523a2206206994597c13d831ec7' group by 2 order by 1 desc limit 10000; -- execution: 36 s 10 ms
