...
while [ "$d" != $until ]; do
  ...
  psql -c "COPY dev.eth.logs FROM 's3://aws-public-blockchain-copy/logs/date=$d/' IAM_ROLE 'arn:aws:iam::729713441316:role/service-role/AmazonRedshift-CommandsAccessRole-20221031T131305' FORMAT AS PARQUET SERIALIZETOJSON"
